       ...
       try { 
           ...
           if(!validateEmail(email)&&email)
           {
            ...
            const msg = {
                ...
                text: 'Password Reset',
                html: `Hi, <h1>${user.name.toUpperCase()}</h1> Click on the link to reset your password :<a href="${`http://localhost:3000/password/reset/${ciphertext}`}"><button type="button" class="btn btn-outline-success">RESET PASSWORD</button></a>`,
        }
